...
- Commodity lock is the main repair mechanism for STEEP slow-growth stress, and its effectiveness is materially stronger in `STEEP_HIGH_RATE` than in `STEEP_LOW_RATE`.
