...
| Credit lock | `FLAT_LOW_RATE`, `FLAT_HIGH_RATE`, `STEEP_LOW_RATE`, `STEEP_HIGH_RATE`, `INVERTED` | `D_CREDIT_SPREAD_15D > 0.10` and `SPY <= MA20` | `SPY > MA50` and `CREDIT_LEVEL_Z_252D < 0.9` | Price-confirmed and still-elevated credit stress | Capture sustained and stair-step stress such as 2008 and 2022 |
...
- Credit unlock requires `SPY > MA50` together with `CREDIT_LEVEL_Z_252D < 0.9`.
- Commodity trigger is not part of the final mainline.
